...
if ($op == "delete") {
    ...
    if ($q1) {
        ...
        header("refresh:0;location:detail6.php"); // jangan lupa ini diganti --------------------------------
    } else {
...
if ($op == 'ulasan_sukses') {
    ...
    header("refresh: 0;url=detail6.php");
...
$sql = "SELECT rating FROM review WHERE id_resto = 6"; // jangan lupa ini juga diganti idnya --------------------------------
...
<head>
    ...
    <title>J.Co - Plaza Ambarrukmo</title>
...
<body>
    ...
    <section class="banner">
        <img src="img/jco1.jpg" alt="Banner Image" style="filter: brightness(100%)"> <!-- jangan lupa ini fotonya juga diganti -------------------------------- -->
    </section>

    <main>
        <div class="container">
            <div class="restaurant-info">
                <h1>J.Co - Plaza Ambarrukmo</h1>
                <p
                ...
                <p style="opacity: 0.8; margin-top: 0px; margin-bottom: 0px;">Ground Floor , A - 35 Plaza Ambarukmo, Jl. Laksda Adisucipto, Ambarukmo, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281.</p>
                <p style="font-weight: bold; margin-top: 0px;">(0274)4331192</p>
                <div class="tags">
                    <span>Coffee</span>
                    <span>Tea</span>
                    <span>Smoothies</span>
                ...
                <p style="margin-bottom: 0px; opacity: 0.8">Buka : 10.00-22.00</p>
                <p style="margin-top: 0px; opacity: 0.8">Rp. 25.000 - Rp. 70.000</p>
                <a href="https://maps.app.goo.gl/DKfCbBVdo3YNf2h47" target="_blank"> <!--- maps linknya -------------------------------------------->
                    <button
            ...
            <section class="fitur">
                ...
                <div class="info">
                    ...
                    <div class="item"><span><img src="img/check.png" width="20px"
                                style="margin-right: 10px">Toilet khusus pengguna kursi roda</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px"
                                style="margin-right: 10px">Wi-Fi</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Pembayaran NFC dengan ponsel</span></div>
            ...
            <section class="fitur">
                <div class="contribute">
                    ...
                    <?php if (empty($_SESSION['user'])) { ?>
                        ...
                        <?php } else { ?>
                        <a href="ulas.php?resto=6"> <!-- id resto jgn lupa ---------------------------------------------->
                            <?php } ?>
                            <button
            ...
            <section class="fitur">
                <div class="review-section">
                    ...
                    <div class="review">
                        <?php
                        $sql = "SELECT * FROM review WHERE id_resto = 6 ORDER BY date DESC"; // jangan lupa ini juga diganti idnya --------------------------------
                        ...
                        <div class="review-grid">
                                ...
                                <div style="margin-top: 10px;">
                                    <?php if ($user_session == $user_id) { ?>
                                        ...
                                        <a href="detail6.php?op=delete&id=<?php echo $id ?>" 
