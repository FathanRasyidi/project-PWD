...
if ($op == "delete") {
    ...
    if ($q1) {
        ...
        header("refresh:0;location:detail2.php"); // jangan lupa ini diganti --------------------------------
    } else {
...
if ($op == 'ulasan_sukses') {
    ...
    header("refresh: 0;url=detail2.php");
...
$sql = "SELECT rating FROM review WHERE id_resto = 2"; // jangan lupa ini juga diganti idnya --------------------------------
...
<head>
    ...
    <title>Mie Gacoan Babarsari</title>
...
<body>
    ...
    <section class="banner">
        <img src="img/gacoan1.jpg" alt="Banner Image" style="filter: brightness(100%)"> <!-- jangan lupa ini fotonya juga diganti -------------------------------- -->
    </section>

    <main>
        <div class="container">
            <div class="restaurant-info">
                <h1>Mie Gacoan Babarsari</h1>
                <p
                ...
                <p style="opacity: 0.8; margin-top: 0px; margin-bottom: 0px;">Jl. Babarsari Ruko Raflesia Blok B7-B10, Jl. Raya Kledokan, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281.</p>
                <p style="font-weight: bold; margin-top: 0px;">(0274) 111222</p>
                <div class="tags">
                    <span>Noodles</span>
                    <span>Dimsum</span>
                    <span>Smoothies</span>
                ...
                <p style="margin-bottom: 0px; opacity: 0.8">Buka : 09.00-21.00</p>
                <p style="margin-top: 0px; opacity: 0.8">Rp. 5.000 - Rp. 35.000</p>
                <a href="https://maps.app.goo.gl/6xUNBwqgVMWwjJri6" target="_blank"> <!--- maps linknya -------------------------------------------->
                    <button
            ...
            <section class="fitur">
                <div class="contribute">
                    ...
                    <?php if (empty($_SESSION['user'])) { ?>
                        ...
                        <?php } else { ?>
                        <a href="ulas.php?resto=2"> <!-- id resto jgn lupa ---------------------------------------------->
                            <?php } ?>
                            <button
            ...
            <section class="fitur">
                <div class="review-section">
                    ...
                    <div class="review">
                        <?php
                        $sql = "SELECT * FROM review WHERE id_resto = 2 ORDER BY date DESC"; // jangan lupa ini juga diganti idnya --------------------------------
                        ...
                        <div class="review-grid">
                                ...
                                <div style="margin-top: 10px;">
                                    <?php if ($user_session == $user_id) { ?>
                                        ...
                                        <a href="detail2.php?op=delete&id=<?php echo $id ?>" 
