...
if ($op == "delete") {
    ...
    if ($q1) {
        ...
        header("refresh:0;location:detail5.php"); // jangan lupa ini diganti --------------------------------
    } else {
...
if ($op == 'ulasan_sukses') {
    ...
    header("refresh: 0;url=detail5.php");
...
$sql = "SELECT rating FROM review WHERE id_resto = 5"; // jangan lupa ini juga diganti idnya --------------------------------
...
<body>
    ...
    <section class="banner">
        <img src="img/otw1.jpg" alt="Banner Image" style="filter: brightness(100%)"> <!-- jangan lupa ini fotonya juga diganti -------------------------------- -->
    </section>
    ...
    <main>
        <div class="container">
            <div class="restaurant-info">
                ...
                <p style="opacity: 0.8; margin-top: 0px; margin-bottom: 0px;">Jl. Sukun Raya No.8, Jaranan, Banguntapan, Kec. Banguntapan, Kabupaten Bantul, Daerah Istimewa Yogyakarta 55281.</p>
                <p style="font-weight: bold; margin-top: 0px;">081228666605</p>
                <div class="tags">
                    <span>Noodles</span>
                    <span>Dimsum</span>
                    <span>Smoothies</span>
                ...
                <p style="margin-bottom: 0px; opacity: 0.8">Buka : 11.00-21.00</p>
                <p style="margin-top: 0px; opacity: 0.8">Rp. 18.000 - Rp. 52.000</p>
                <a href="https://maps.app.goo.gl/KyuSH4ZVZ8hK27FSA" target="_blank"> <!--- maps linknya -------------------------------------------->
                    <button
            ...
            <section class="fitur">
                ...
                <div class="info">
                    ...
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Makanan
                            halal</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Parkir Gratis</span>
                    </div>
            ...
            <section class="fitur">
                <div class="contribute">
                    ...
                    <?php if (empty($_SESSION['user'])) { ?>
                        ...
                        <?php } else { ?>
                        <a href="ulas.php?resto=5"> <!-- id resto jgn lupa ---------------------------------------------->
                            <?php } ?>
                            <button
            ...
            <section class="fitur">
                <div class="review-section">
                    ...
                    <div class="review">
                        <?php
                        $sql = "SELECT * FROM review WHERE id_resto = 5 ORDER BY date DESC"; // jangan lupa ini juga diganti idnya --------------------------------
                        ...
                        <div class="review-grid">
                                ...
                                <div style="margin-top: 10px;">
                                    <?php if ($user_session == $user_id) { ?>
                                        ...
                                        <a href="detail5.php?op=delete&id=<?php echo $id ?>" 
