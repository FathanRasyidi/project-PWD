...
if ($op == "delete") {
    ...
    if ($q1) {
        ...
        header("refresh:0;location:detail3.php"); // jangan lupa ini diganti --------------------------------
    } else {
...
if ($op == 'ulasan_sukses') {
    ...
    header("refresh: 0;url=detail3.php");
...
$sql = "SELECT rating FROM review WHERE id_resto = 3"; // jangan lupa ini juga diganti idnya --------------------------------
...
<head>
    ...
    <title>Ayam Goreng Suharti</title> <!-- jangan lupa ini juga diganti ------------------------------------------------------------------------>
...
<body>
    ...
    <section class="banner">
        <img src="img/suharti1.jpg" alt="Banner Image" style="filter: brightness(100%)"> <!-- jangan lupa ini fotonya juga diganti -------------------------------- -->
    </section>

    <main>
        <div class="container">
            <div class="restaurant-info">
                <h1>Ayam Goreng Suharti</h1>
                <p
                ...
                <p style="opacity: 0.8; margin-top: 0px; margin-bottom: 0px;">Jl. Laksda Adisucipto No.208, Janti, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281.</p>
                <p style="font-weight: bold; margin-top: 0px;">(0274)484522</p>
                <div class="tags">
                    <span>Chicken</span>
                    <span>Vegetables</span>
                    <span>Traditional</span>
                </div>
                <p style="margin-bottom: 0px; opacity: 0.8">Buka : 08.00-21.00</p>
                <p style="margin-top: 0px; opacity: 0.8">Rp. 30.000 - Rp. 120.000</p>
                <a href="https://maps.app.goo.gl/yN7BuMSCh9A4H7zF7" target="_blank"> <!--- maps linknya -------------------------------------------->
                    <button
            ...
            <section class="fitur">
                ...
                <div class="info">
                    ...
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Makanan
                            halal</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Pintu masuk khusus pengguna kursi roda</span>
                    </div>
                    ...
                    <div class="item"><span><img src="img/check.png" width="20px"
                                style="margin-right: 10px">Musik live</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Menerima
                            reservasi</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Nyaman</span></div>
            ...
            <section class="fitur">
                <div class="contribute">
                    ...
                    <?php if (empty($_SESSION['user'])) { ?>
                        ...
                        <?php } else { ?>
                        <a href="ulas.php?resto=3"> <!-- id resto jgn lupa ---------------------------------------------->
                            <?php } ?>
                            <button
            ...
            <section class="fitur">
                <div class="review-section">
                    ...
                    <div class="review">
                        <?php
                        $sql = "SELECT * FROM review WHERE id_resto = 3 ORDER BY date DESC"; // jangan lupa ini juga diganti idnya --------------------------------
                        ...
                        <div class="review-grid">
                                ...
                                <div style="margin-top: 10px;">
                                    <?php if ($user_session == $user_id) { ?>
                                        ...
                                        <a href="detail3.php?op=delete&id=<?php echo $id ?>" 
