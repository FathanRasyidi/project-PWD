...
if ($op == "delete") {
    ...
    if ($q1) {
        ...
        header("refresh:0;location:detail7.php"); // jangan lupa ini diganti --------------------------------
    } else {
...
if ($op == 'ulasan_sukses') {
    ...
    header("refresh: 0;url=detail7.php");
...
$sql = "SELECT rating FROM review WHERE id_resto = 7"; // jangan lupa ini juga diganti idnya --------------------------------
...
<head>
    ...
    <title>McDonald's Ambarukmo</title>
...
<body>
    ...
    <section class="banner">
        <img src="img/mcd1.jpg" alt="Banner Image" style="filter: brightness(100%)"> <!-- jangan lupa ini fotonya juga diganti -------------------------------- -->
    </section>

    <main>
        <div class="container">
            <div class="restaurant-info">
                <h1>McDonald's Ambarukmo</h1>
                <p
                ...
                <p style="opacity: 0.8; margin-top: 0px; margin-bottom: 0px;">Jl. Laksda Adisucipto No.21, Ambarukmo, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281.</p>
                <p style="font-weight: bold; margin-top: 0px;">08118162853</p>
                <div class="tags">
                    <span>Burger</span>
                    <span>Chicken</span>
                    <span>Smoothies</span>
                </div>
                <p style="margin-bottom: 0px; opacity: 0.8">Buka : 24 Jam</p>
                <p style="margin-top: 0px; opacity: 0.8">Rp. 15.000 - Rp. 70.000</p>
                <a href="https://maps.app.goo.gl/yihov8R8GyRmzpjk7" target="_blank"> <!--- maps linknya -------------------------------------------->
                    <button
            ...
            <section class="fitur">
                ...
                <div class="info">
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Drive-Thru</span></div>
                    ...
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Kartu
                            debit</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Pelayanan cepat</span></div>
                    <div class="item"><span><img src="img/check.png" width="20px" style="margin-right: 10px">Cepat Saji</span></div>
            ...
            <section class="fitur">
                <div class="contribute">
                    ...
                    <?php if (empty($_SESSION['user'])) { ?>
                        ...
                        <?php } else { ?>
                        <a href="ulas.php?resto=7"> <!-- id resto jgn lupa ---------------------------------------------->
                            <?php } ?>
                            <button
            ...
            <section class="fitur">
                <div class="review-section">
                    ...
                    <div class="review">
                        <?php
                        $sql = "SELECT * FROM review WHERE id_resto = 7 ORDER BY date DESC"; // jangan lupa ini juga diganti idnya --------------------------------
                        ...
                        <div class="review-grid">
                                ...
                                <div style="margin-top: 10px;">
                                    <?php if ($user_session == $user_id) { ?>
                                        ...
                                        <a href="detail7.php?op=delete&id=<?php echo $id ?>" 
